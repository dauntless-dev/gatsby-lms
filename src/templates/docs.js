...
<h2 style={{textAlign:`center`}}>EPIC <span style={{color:`#f44336`}}>Cyber Monday</span> Japanese Course Sale (2020)</h2>
...
<p style={{textAlign:`center`, padding:`0 20px`}}><strong>We've located the <span onClick={() => {netlifyIdentity.open()}}>best</span> Japanese products and offers for you here:</strong></p>
